...
const About = () => {
    return (
        ...
        <span className='first-letter'>D</span>awn, an artist from Tampa, FL, has been creating fashion dolls, dresses, and fun creatures for over 20 years!
        ...
        Beginning with sewing and dyeing her own teddy bears and making cute outfits for her porcelain dolls eventually she entered the world of professional doll repaints.
